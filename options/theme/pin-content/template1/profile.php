...
<div class="col-md-12 col-sm-12 col-xs-12 pinterest-stats">		
	<div class="col-md-12 col-sm-12 col-xs-12 pinterest-stat-left">					
		...
		<div class="col-md-4 col-sm-4 col-xs-12 pinterest-stat-default pinterest-stat-board">
			<div class="icon-desc-default">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 pinterest-stat-default pinterest-stat-follow user_follow-options <?php if($user_follow =='on') echo "active"; ?>">	
			<div class="icon-desc-default">		
	...
	<?php if($user_counts == 'on'){ ?>
	<div class="col-md-12 col-sm-12 col-xs-12 pinterest-stat-left user_counts-options <?php if($user_counts == 'on') echo "active"; ?>" id="user_counts-template">		
		<?php if($user_counts_followers == 'on'){ ?>
		<div class="col-md-4 col-sm-4 col-xs-12 pinterest-stat-default pinterest-stat-followers user_followers-options <?php if($user_counts_followers == 'on') echo "active"; ?>" id="count-number">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 pinterest-stat-default pinterest-stat-following user_following-options <?php if($user_counts_following == 'on') echo "active"; ?>" id="count-number">
